        ...
        <table class="table">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="form-control" name="cucimobil_idtransaksi" value="<?=$cucimobil_idtransaksi?>" required></td>
                </tr>
                <tr>
                    <td> Tanggal </td>
                ...
                <tr>
                    ...
                    <a href="<?=site_url('C_Cucimobil')?>"><input type="button" value="CANCEL" class="btn btn-danger btn-sm scroll-click"></td>
                </tr>
            </table>
        </form>
    </body>
